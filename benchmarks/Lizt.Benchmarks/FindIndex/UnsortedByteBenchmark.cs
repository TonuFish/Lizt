...
namespace Lizt.Benchmarks.FindIndex
{
    ...
    public class UnsortedByteBenchmark
    {
        private int _iterations = 3_000_000;
        private byte[] _source;
        private List<byte> _sourceAsList;
        ...
        private static bool Match(byte x) => x == byte.MaxValue;
        ...
        public void Setup()
        {
            ...
            _sourceAsList = new List<byte>(_source);
        }
        ...
        public int System_Array()
        {
            ...
            for (int ii = 0 ; ii < _iterations ; ii++)
            {
                result = Array.FindIndex<byte>(_source, Match);
            }
